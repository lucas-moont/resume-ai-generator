...
export function AppHeader() {
  ...
  return (
    <header className="no-print border-b border-stone-200/80 bg-white/80 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/80">
      <div className="mx-auto flex max-w-[1920px] flex-wrap items-end justify-between gap-4 px-4 py-5 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Tooltip label="Check GitHub connection" placement="bottom">
            <button
              type="button"
